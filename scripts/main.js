...
$packages["go-extension"] = (function() {
	...
	main = function() {
		$global.document.addEventListener($externalize("DOMContentLoaded", $String), $externalize((function() {
			$global.document.getElementById($externalize("title", $String)).innerText = $externalize("\xD0\x9F\xD1\x80\xD0\xB8\xD0\xB2\xD0\xB5\xD1\x82 \xD0\xB8\xD0\xB7 GopherJS!", $String);
		}), funcType));
	};
	$init = function() {
		$pkg.$init = function() {};
